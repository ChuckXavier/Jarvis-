...
ETF_UNIVERSE = [
    ...
    # ── TIER 5: V4.2 LEVERAGED ETFs (5 ETFs) ──
    {"ticker": "QLD",  "name": "ProShares Ultra QQQ",       "asset_class": "leveraged",    "sector": "us_tech_2x",          "role": "2x Nasdaq-100 (ACTIVE mode)"},
    {"ticker": "SSO",  "name": "ProShares Ultra S&P 500",   "asset_class": "leveraged",    "sector": "us_large_cap_2x",     "role": "2x S&P 500 (ACTIVE mode)"},
    {"ticker": "ROM",  "name": "ProShares Ultra Technology", "asset_class": "leveraged",   "sector": "us_tech_2x",          "role": "2x Technology (ACTIVE mode)"},
    {"ticker": "UYG",  "name": "ProShares Ultra Financials", "asset_class": "leveraged",   "sector": "us_financials_2x",    "role": "2x Financials (ACTIVE mode)"},
    {"ticker": "DIG",  "name": "ProShares Ultra Energy",    "asset_class": "leveraged",    "sector": "us_energy_2x",        "role": "2x Oil & Gas (ACTIVE mode)"},


    # ── TIER 6: V4.2 CRISIS ALPHA (3 ETFs) ──
    {"ticker": "GDX",  "name": "VanEck Gold Miners",        "asset_class": "commodity",    "sector": "gold_miners",         "role": "Crisis alpha (SAFETY mode)"},
    {"ticker": "DBMF", "name": "iMGP Managed Futures",      "asset_class": "alternative",  "sector": "managed_futures",     "role": "Crisis alpha (SAFETY mode)"},
    {"ticker": "BIL",  "name": "SPDR 1-3 Month T-Bill",     "asset_class": "fixed_income", "sector": "us_treasury_ultra_short", "role": "Cash equivalent (SAFETY mode)"},
]
